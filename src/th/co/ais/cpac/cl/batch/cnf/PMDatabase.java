 ...
 * @author Optimus
 */
public class PMDatabase extends CNFFileTemplate {

  public PMDatabase() {
  }

  public PMDatabase(String nfc) {
    super(nfc);
  }
  ...
  public static void main(String[] args) {
    ...
    PMDatabase cc = new PMDatabase("D:\\AppsServer\\apache-tomcat-8.0.9\\Apps\\gbe\\conf\\common.properties");
    System.out.println(cc.dump("\r\n"));

    System.out.println(new PMDatabase().dump("\r\n"));
